...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow"><?= translate('update_your_script')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('update')?></a></li>
	...
	<div id="page-content">
		<div class="panel">
		    ...
		    <div class="panel-body">
				...
				<br>
				<div class="text-left">
                    <h4><?= translate('update')?></h4>
                </div>
				<hr>
				<form class="form-horizontal"  method="POST" action="<?=base_url()?>admin/update/do_update" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="fname"><b><?= translate('upload_the_update_file')?> <span class="text-danger">*</span></b></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-8 text-right">
							<button type="submit" class="btn btn-primary btn-sm btn-labeled fa fa-save"><?=translate('update')?></button>
						</div>
					</div>
				</form>
		    </div>
