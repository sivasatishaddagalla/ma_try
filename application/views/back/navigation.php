		...
		<div class="nano">
			<div class="nano-content">
							...
							<ul class="collapse">
								<?php if ($this->Crud_model->admin_permission('free_members')){ ?>
									<li <?php if($page_name=="free_members"){ ?> class="active-link" <?php } ?>>
										<a href="<?=base_url()?>admin/members/free_members"><i class="fa fa-user-o"></i><?php echo translate('free_members')?></a>
									</li>
								<?php } if ($this->Crud_model->admin_permission('premium_members')){?>
									<li <?php if($page_name=="premium_members"){ ?> class="active-link" <?php } ?>>
										<a href="<?=base_url()?>admin/members/premium_members"><i class="fa fa-user"></i><?php echo translate('premium_members')?></a>
									</li>
				...
				<?php if ($this->Crud_model->admin_permission('online_knowledge_base')){?>
                    <li>
						<a href="https://activeitzone.com/docs/active-matrimonial-cms/" target="_blank">
