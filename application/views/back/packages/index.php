	...
	<div id="page-content">
		<div class="panel">
		    ...
		    <div class="panel-body">
                <div class="text-left">
                    <h4><?= translate('cron_job_add_instruction')?></h4>
                </div>
				<i style="color:red"><?= translate('you_must_add_a_cron_job_to_check_the_validity_of_the_package.') ?></i>
				<br><br>
                <ol>
                    <li>
                        <?php echo translate('To set a cron job, login to your cpanel and find the Cron Jobs option.'); ?>
                    </li>
                    <li>
                        <?php echo translate('Go to Cron Jobs.'); ?>
                    </li>
                    <li>
                        <?php echo translate('Add new Cron Job.'); ?>
                    </li>
                    <li>
                    	<?php echo translate('Select time period of Every Day.'); ?>
                    </li>
                    <li>
                        <?php echo translate('Set command as'); ?> wget -O – http://your-domain-name.com/home/package_expiry_check
                    </li>
                </ol>
		    </div>
		</div>
					        ...
					        <div class="panel panel-colorful panel-dark">
					            <div class="panel-body">
									<div class="text-center" style="margin-top: 22px;">
										...
										<p><?php echo translate('duration:')?> <?=$value->duration?> <?php echo translate('days')?></p>
									</div>
									<div class="col-sm-12">
