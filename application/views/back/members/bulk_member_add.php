...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow"><?= translate('bulk_add_member')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('bulk_add_member')?></a></li>
	...
	<div id="page-content">
		<div class="panel">
            ...
            <div class="panel-body">
                <div class="text-left">
                    <h4><?= translate('More Instructions')?></h4>
                </div>
                <hr>
                <ol>
                    <li>
                        <?= translate('Gender, On Behalf and Package should be in')?> <code><?= translate('numerical ids')?></code>.
                    </li>
                    <li>
                        <?= translate('Male Id = 1, Female Id = 2')?>
                    </li>
                    <li>
                        <?= translate('Click the')?> <code><?= translate('On Behalf and Package modals/pop-ups')?></code> <?= translate('to see the related ids')?>
                    </li>
                    <li>
                    ...
                    <li>
                        <?= translate('Members should be uploaded successfully.')?>
                    </li>
                </ol>
                <div class="form-group">
            ...
            <div class="panel-body">
                <div class="text-left">
                    <h4><?= translate('Upload members')?></h4>
                </div>
                <hr style="height:1px; border:none; background-color:#000;">
                <form class=""  method="POST" action="<?=base_url()?>admin/bulk_member_add/do_add" enctype="multipart/form-data">
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-8 text-right">
							<button type="submit" class="btn btn-primary btn-sm btn-labeled fa fa-save"><?=translate('upload')?></button>
						</div>
					</div>
                </form>
                <hr>
