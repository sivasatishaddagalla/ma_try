		...
		<div id="page-title">
			...
			<div class="searchbox">
				<div class="pull-right">
					<a href="<?=base_url()?>admin/members/<?=$parameter?>/view_member/<?=$value->member_id?>" class="btn btn-danger btn-sm btn-labeled fa fa-step-backward" type="submit"><?php echo translate('go_back')?></a>
				</div>
			</div>
		</div>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
