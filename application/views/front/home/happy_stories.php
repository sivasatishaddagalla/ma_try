                                ...
                                <div class="card-image">
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <div class="home_shory" style="background-image: url('<?=base_url()?>uploads/happy_story_image/<?=$images[0]['thumb']?>')"></div>
                                        <?php
                                        }
                                        else {
                                        ?>
                                            <!-- <img src="<?=base_url()?>uploads/happy_story_image/default_image.jpg"> -->
                                            <div class="home_shory" style="background-image: url('<?=base_url()?>uploads/happy_story_image/default_image.jpg')"></div>
                                        <?php
                                        }
                                    ?>
                                </div>
                                <div class="card-body">
                                    <small><em><?= date_format(date_create($happy_storie->post_time),"d, F Y")?> </em></small>
                                    <h3 class="heading heading-5 strong-500 story_heading">
                                    <a href="<?=base_url()?>home/stories/story_detail/<?=$happy_storie->happy_story_id?>" style="cursor: pointer !important;"><?=substr($happy_storie->title,0,23)?><?php if(strlen($happy_storie->title) > 23){echo '..';}?></a>
                                    </h3>
                                </div>
                            </div>
                        </div>
