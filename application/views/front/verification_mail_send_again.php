...
<html>
    ...
    <body>
        ...
        <?php if($member_approval == 'yes'){ ?>
            <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?=base_url()?>uploads/registration_message_image/<?=$registration_message_image_data[0]['image']?>); background-position: bottom bottom;">
        <?php } else { ?>
                        ...
                        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                            <div class="form-card form-card--style-2 z-depth-3-top">
                                <div class="form-body">
                                    ...
                                    <form class="form-default" role="form" method="post" action="<?=base_url()?>home/verification_mail_send_again/resend">
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-12 text-center" style="font-size: 12px;">
                                                <a class="c-gray-light" href="<?=base_url()?>home/login"><?php echo translate('log_in_page'); ?></a>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row mt-3">
